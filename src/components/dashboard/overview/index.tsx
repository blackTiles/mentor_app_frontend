...
import { MessageSquare, Calendar, Users, MoveRight } from "lucide-react";
    ...
    <div className="px-4 py-6">
      ...
      <div className="mt-4 sm:mt-12">
        <div className="mb-4 flex items-center justify-between">
          ...
          <Button
            onClick={() => navigate(`/dashboard/${user.role}/workspaces`)}
            className="bg-gray-800 hover:bg-gray-700 flex justify-center items-center"
          >
            See All Workspaces
            <MoveRight size={10} className="mr-0" />
          </Button>
        </div>
        <div className="w-full h-full">
          {loadingWorkspaces ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {workspaces.slice(-3).map((workspace: WorkspaceProps) => (
                <WorkspaceCard
                  key={workspace._id}
                  _id={workspace._id}
                  name={workspace.name}
