...
export default function Workspace() {
  ...
  const fetchWorkspaceData = React.useCallback(async () => {
    try {
      const response = await API.get(`/workspace/get-workspace/${workspaceId}`);
      if (response.status === 200) {
        const fetchedWorkspace = response.data.workspace;
...
//       fetchWorkspaceData();
//     }
//   }, [workspaces, workspaceId, setWorkspace, fetchWorkspaceData]);
